...
resource "azurerm_linux_virtual_machine" "main" {  
  ...
  provisioner "remote-exec" { 
    inline = [
      ...
      "cd",
      "chmod 755 create-contour-default-tls.sh create-cnrs-default-tls.sh create-cnrs-slim.sh create-metadata-store-ingress-tls.sh create-tap-values.sh tap-install.sh",
      "./create-contour-default-tls.sh ./create-cnrs-default-tls.sh ./create-cnrs-slim.sh ./create-metadata-store-ingress-tls.sh ./create-tap-values.sh",
